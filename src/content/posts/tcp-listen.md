...
<img src="/images/posts/tcp-listen/tcp-socket.png" loading="lazy" decoding="async" />

三次握手发生在系统调用 `connect()`,`listen()`阶段：

 <img src="/images/posts/tcp-listen/tcp-socket-3whs.png" loading="lazy" decoding="async" />
