...
<img src="/images/posts/capture-tcp-3-way-handshake/system-notify.png" loading="lazy" decoding="async" />
...
<img src="/images/posts/capture-tcp-3-way-handshake/img01.png" loading="lazy" decoding="async" />

先回忆一下 TCP 三次握手过程，简单画了个图：

<img src="/images/posts/capture-tcp-3-way-handshake/img02.png" loading="lazy" decoding="async" />

再看看 TCP 报文段头部格式：

<img src="/images/posts/capture-tcp-3-way-handshake/img03.png" loading="lazy" decoding="async" />
...
<img src="/images/posts/capture-tcp-3-way-handshake/img04.png" loading="lazy" decoding="async" />

第二次握手：服务端 172.67.149.132 收到 [SYN] 包，回应了一个 [SYN, ACK] 包给客户端 192.168.100.191，此时，Ack = 0x4ce45751, Seq = 0xc112f693,Flags: (SYN, ACK).

<img src="/images/posts/capture-tcp-3-way-handshake/img05.png" loading="lazy" decoding="async" />

<img src="/images/posts/capture-tcp-3-way-handshake/img06.png" loading="lazy" decoding="async" />

第三次握手：最后，客户端 192.168.100.191 回应一个 [ACK] 包，此时，Ack = 0xc112f694, Seq = 0x4ce45751, Flags: (ACK).

<img src="/images/posts/capture-tcp-3-way-handshake/img07.png" loading="lazy" decoding="async" />

<img src="/images/posts/capture-tcp-3-way-handshake/img08.png" loading="lazy" decoding="async" />
