...
诡秘之主的「错误」途径符号。如果你也喜欢诡秘之主——赞美愚者（从口袋掏出单片眼镜戴在右眼）。

## 许可

主题采用 [MIT](https://opensource.org/licenses/MIT) 许可，本站修改同样沿用。

除非特别注明，博客文章均以 [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/) 许可发布。
